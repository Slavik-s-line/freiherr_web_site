Music.create(title: 'Night at Work | Instrumental Chill Music Mix',
...
Music.create(title: 'Anson Seabra - Songs I Wrote In My Bedroom',
             description: 'I am just going to leave this here for you all, relax a bit.',
             url: 'https://www.youtube.com/embed/NpQbEadBq_w')
Music.create(title: 'Dark Academia | Distant Thunderstorms & Fireplace',
